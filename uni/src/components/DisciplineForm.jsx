          ...
          <div className="flex gap-14">
            <div className="modaldiv px-4 py-5 flex flex-col gap-7 border-[1px] border-gray-400">
              <label className="modaldiv flex h-12 overflow-hidden items-center border-[1px] border-[#B8CCE0]">
                ...
                >
                  {selectedId !== null ? (
                    <span className=" h-full shadowWhite text-black text-2xl font-nuni font-bold w-full flex items-center justify-center z-20 gap-5">
                      {" "}
                    ...
                    <span className=" h-full shadowWhite text-black text-2xl font-nuni font-bold w-full flex items-center justify-center z-20">
                      Выбрать
                    </span>
                  )}
                  {choose && (
                    <div className="shadowThird absolute w-72 px-4 pb-5 pt-10 z-10 top-44">
                      ...
                      <div className="flex flex-col items-center justify-center pt-3 gap-2">
                        <div
                          ...
                          className="text-2xl text-black bg-white rounded-full w-14 h-14 flex items-center justify-center"
                        >
                          +
                        </div>
